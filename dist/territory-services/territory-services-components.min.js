$(document).ready(function(){var e=document.querySelectorAll(".accordion-toggler");0<e.length&&e.forEach(function(n){var t="accordion";n.querySelector("a.open").addEventListener("click",e=>{e&&e.preventDefault();for(var l=n.nextElementSibling;l&&l.classList.contains(t);)$(l.querySelector(".collapse")).collapse("show"),l=l.nextElementSibling}),n.querySelector("a.close").addEventListener("click",e=>{e&&e.preventDefault();for(var l=n.nextElementSibling;l&&l.classList.contains(t);)$(l.querySelector(".collapse")).collapse("hide"),l=l.nextElementSibling})})});
...
function quickExit(){window.open("https://nt.gov.au","_newtab"),window.location.replace("https://www.google.com")}$(function(){$("#quickexit").on("click",function(i){quickExit()}),$("#quickexit a").on("click",function(i){i.stopPropagation()}),$(document).keyup(function(i){$("#quickexit").length&&27==i.keyCode&&quickExit()})});
var $btn=$(".ntg-rich-media.ntg-rich-media--video-embed button").first(),$transcript=$("#ntg-rich-media__transcript-container");function updateButtonLabel(){$btn.hasClass("collapsed")?$btn.html("Show video transcript"):$btn.html("Hide video transcript")}updateButtonLabel(),$btn.on("click",function(){$btn.toggleClass("collapsed"),$transcript.slideToggle(200),updateButtonLabel()});
$(document).ready(function(){setTimeout(function(){$("#searchToggleMobile").click(function(){$(".navbar-normal").hide(),$(".navbar-search-mobile").fadeIn()}),$(".navbar-search-mobile .btn-close").click(function(){$(".navbar-search-mobile").hide(),$(".navbar-normal").fadeIn()})},5)});
function initSideNav(){var e=document.querySelectorAll(".ntg-side-nav__collapser");if(!e)return!1;for(var s=0;s<e.length;s++)e[s].addEventListener("click",function(e){e.preventDefault();e=this.parentElement.getElementsByClassName("collapse")[0];e.classList.contains("show")?(e.classList.remove("show"),this.classList.add("collapsed")):(e.classList.add("show"),this.classList.remove("collapsed"))})}$(document).ready(function(){initSideNav()});
function initStickyNav(){var i;$('[data-component="ntg-sticky-nav"]').length&&($("ul.ntg-sticky-nav li a").each(function(){var t=$(this).attr("href");t&&!t.startsWith("content_container")&&$(t).addClass("scroll-point")}),i=$("ul.ntg-sticky-nav"),$("#content").addClass("no-target-outline"),$(window).scroll(function(){$("header").isInViewport()?$("#content").removeClass("ntg-sticky-nav-active"):$("#content").addClass("ntg-sticky-nav-active");var e=$(this).scrollTop()+132;$(".scroll-point").each(function(t){var i=$(this).closest("div").offset().top,n=i+$(this).closest("div").height(),a=$(this).attr("id");$(".ntg-sticky-nav__item[data-nav-item-name="+a+"]").removeClass("active"),i<=e&&e<=n&&$(".ntg-sticky-nav__item[data-nav-item-name="+a+"]").addClass("active")})}).scroll(),$(i).find('a[href^="#"]').click(function(t){$(i).find("li.active").removeClass("active"),$(this).closest("li").addClass("active"),$("html, body").animate({scrollTop:$('[id="'+jQuery.attr(this,"href").substr(1)+'"]').offset().top-110},50,function(){})}))}$(document).ready(function(){initStickyNav()}),$.fn.isInViewport=function(){var t=$(".intro-section").outerHeight(),t=$(this).offset().top+t,i=t+$(this).outerHeight(),n=$(window).scrollTop(),a=n+$(window).height();return n<i&&t<a};
$(document).ready(function(){setTimeout(function(){$(".ntg-body table").each(function(){$(this).hasClass("table")||$(this).addClass("table").wrap('<div class="table-responsive">')})},5)});